...
public class  DealAdapter extends RecyclerView.Adapter<DealAdapter.DealViewHolder>{
    ...
    public class DealViewHolder extends RecyclerView.ViewHolder
        ...
        public DealViewHolder(View itemView) {
            ...
            tvTitle.setText(deal.getTitle(tvTitle.getText().toString()));
            tvDescription.setText(deal.getDescription(tvDescription.getText().toString()));
            tvPrice.setText(deal.getPrice(tvPrice.getText().toString()));
